...
//view invoices
$view_invoices = $invoices->view_invoices($_SESSION['client_ID']);
...
<body>
							...
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									<li class="nav-item active">
										<a class="nav-link" href="supplements.php">Buy supplements</a>
									</li>
	...
	<section >
		<div class="col-lg12">
			<div class="container">
				<h2 class="text-muted text-center">Your invoices</h2>
				<div class="table-responsive" id="order_table">
                	<table class="table table-bordered table-striped" id="order_table">
                    	...
                    	<tbody>
                        <?php foreach ($view_invoices as $row) {
                            extract($row);
                            # code...
                            echo '</td><td>';
                            echo $inv_num;
                            ...
                            echo $inv_date;
                            echo '</td><td>';
                            echo '<a href=invoice.php?inv_num='.$inv_num.'><button class="btn btn-info btn-xs"  >View</button></a>&nbsp;'; 
                            echo '</td></tr>';
