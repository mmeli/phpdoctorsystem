            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="mis.php?report=top10" aria-expanded="false"><i class="mr-3 fa fa-table"
                                    aria-hidden="true"></i><span class="hide-menu">Top 10 clients</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="mis.php?report=purchasestat" aria-expanded="false"><i class="mr-3 fa fa-table"
                                aria-hidden="true"></i><span class="hide-menu">Purchase Statistics</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="mis.php?report=clientinfo" aria-expanded="false"><i class="mr-3 fa fa-table"
                                aria-hidden="true"></i><span class="hide-menu">Client Information Query</span></a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">MIS Reports</h3>
                                        ...
                                        echo '<table id="table_id" class="table table-hover">
                                                <thead>
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php foreach ($top_client as $rows): ?>
                                                        <tbody>
                                                        <tr>
                                                                    <td class=""><?php echo $rows['CLIENT']; ?></td>
                                                    ...
                                                    ';
                                                        ...
                                                        <?php foreach ($purchases as $rows): ?>
                                                        <tbody>
                                                        <tr>
                                                                    <td class=""><?php echo $rows['NUM OF PURCHASES']; ?></td>
                                                    ...
                                                    <?php
                                                        ...
                                                        <?php foreach ($client_contact as $rows): ?>
                                                        <tbody>
                                                        <tr>
                                                                    <td class=""><?php echo $rows['CLIENT']; ?></td>
