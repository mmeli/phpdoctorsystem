            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="daytoday.php" aria-expanded="false"><i class="mr-3 fa fa-table"
                                    aria-hidden="true"></i><span class="hide-menu">Day-to-day reports</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                            href="mis.php" aria-expanded="false"><i class="mr-3 fa fa-table"
                                aria-hidden="true"></i><span class="hide-menu">MIS</span></a>
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="m-t-30"> <img src="../assets/images/rethabile.PNG"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title m-t-10" id="hcp_name"></h4>
                                    <h6 class="card-subtitle">HCP</h6>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <?php 
                                    $our_hcp = $hcp->logged_hcp($_SESSION['hcp_id']);
                                    foreach($our_hcp as $ohcp){
                                        extract($ohcp);
                                ...
                                <form class="form-horizontal form-material" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" name="hcp_name" id="hcp_nam" value="<?php echo $name ?>" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" placeholder="" name="hcp_email" id="hcp_emai" value="<?php echo $email ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="123 456 7890" name="hcp_tel" id="hcp_te" value="<?php echo $tel ?>"
                                                class="form-control pl-0 form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" name="hcp_pass" id="hcp_pas" value="<?php echo $password ?>"
                                                class="form-control pl-0 form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white" name="btnHCPupdate">Update
                                                Profile</button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                if(isset($_POST['btnHCPupdate'])){
                                    $hcp->update_hcp($_SESSION['hcp_id'],$_POST['hcp_name'],$_POST['hcp_email'],$_POST['hcp_tel'],$_POST['hcp_pass']);
                                }
