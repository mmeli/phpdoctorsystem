...
<body>
			...
			<div class="container">
				<div class="banner_content text-left">
					...
					<div class="page_link">
						...
						<a href="departments.html">HCP | Sign In</a>
					</div>
				</div>
			</div>
		</div>
	...
	<section >
		<div class="col-lg12">
			<div class="container">
				<h2 class="text-muted text-center">HCP | SIGN IN</h2>
				<form action="" method="post" id="formItem">
					<div class="form-group">
						<label for="id_number">E-mail</label>
						<input type="email" class="form-control single-input text-center" name="email" id="email"  placeholder="Enter e-mail" >
						<small id="email" class="form-text text-muted text-center">We'll never share your ID Number with anyone else.</small> 
					</div>
					<div class="form-group">
					...
					<hr>
					<div align="center">
						<button  id="btnHCP" name="btnHCP" class="btn btn-primary btn-block" >Sign in</button>
					</div>
					<br>
					<br>
				</form>
				<?php
					if(isset($_POST['btnHCP'])){
						$hcp_email = $_POST['email'];
						$password = $_POST['password'];

					if(!empty($hcp_email)  && !empty($password) ){
						$hcp->hcp_login($hcp_email, $password);
					}else{
